<style>
    :root {
        --chat-bg-dark: rgba(24, 24, 27, 0.85);
    ...
    .dark #toggle-chat-btn { background: #18181b; }
    #toggle-chat-btn:hover { transform: scale(1.1); box-shadow: 0 6px 25px rgba(59, 130, 246, 0.6); }
    #toggle-chat-btn.open { background: #3b82f6; color: #fff; transform: rotate(90deg); }
    ...
    .chat-header { background: linear-gradient(135deg, #18181b 0%, #27272a 100%); padding: 16px; text-align: center; border-bottom: 2px solid #3b82f6; }
    .dark .chat-header { background: linear-gradient(135deg, #18181b 0%, #27272a 100%); }
    ...
    #chatbox::-webkit-scrollbar-thumb { background-color: rgba(59, 130, 246, 0.5); border-radius: 10px; }
    ...
    .user-message .msg-bubble { background: linear-gradient(135deg, #3b82f6, #2563eb); color: #fff; font-weight: 500; border-bottom-right-radius: 4px; align-self: flex-end; }
    ...
    .dark .chat-input { background: #18181b; border-color: #3f3f46; color: #fff; }
    .chat-input:focus { border-color: #3b82f6; }

    .chat-send-btn { background: linear-gradient(135deg, #3b82f6, #2563eb); color: #fff; border: none; border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: transform 0.2s ease; }
    ...
    .typing-dot { width: 6px; height: 6px; background: #3b82f6; border-radius: 50%; animation: typing 1.4s infinite ease-in-out both; }
...
<div id="chatbot-wrapper">
    <div class="chat-glass-card">
        <div class="chat-header">
            <h2 class="text-lg font-black text-blue-500 flex items-center justify-center gap-2">🤖 Asistente Spoon's</h2>
        </div>
        <div id="chatbox">
            <div class="flex items-start gap-3 animate-fadeIn bot-message">
                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold flex-shrink-0 shadow-md">S</div>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function addMessage(text, isUser = false) {
            ...
            if (isUser) {
                ...
                messageDiv.innerHTML = `<div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold flex-shrink-0 shadow-md">S</div><div class="msg-bubble">${text}</div>`;
            }
        ...
        function showTyping() {
            ...
            typingDiv.innerHTML = `<div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold flex-shrink-0 shadow-md">S</div><div class="typing-indicator"><div class="typing-dot"></div><div class="typing-dot"></div><div class="typing-dot"></div></div>`;
