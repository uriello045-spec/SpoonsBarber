    ...
    <div class="container mx-auto px-4 max-w-4xl">
        <div class="bg-white dark:bg-[#2a2a2a] p-8 md:p-12 rounded-3xl shadow-xl border border-slate-200 dark:border-zinc-700">
            ...
            <div class="prose prose-slate dark:prose-invert max-w-none text-slate-700 dark:text-slate-300 space-y-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white border-b border-blue-500 pb-2">¿Para qué usamos cookies?</h3>
            ...
            <div class="mt-12 text-center">
                <a href="{{ url('/') }}" class="inline-block bg-blue-600 hover:bg-blue-700 dark:bg-[#3b82f6] dark:hover:bg-blue-500 text-white font-bold py-3 px-8 rounded-full transition-transform transform hover:scale-105 shadow-md">Aceptar y Regresar</a>
            </div>
        </div>
    </div>
</div>
