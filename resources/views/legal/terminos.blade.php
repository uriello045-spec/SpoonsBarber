    ...
    <div class="container mx-auto px-4 max-w-4xl">
        <div class="bg-white dark:bg-zinc-900 p-8 md:p-12 rounded-3xl shadow-xl border border-slate-200 dark:border-zinc-800">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-yellow-600 dark:text-yellow-500 font-bold">Spoon's Barber Shop</p>
            ...
            <div class="prose prose-slate dark:prose-invert max-w-none text-slate-700 dark:text-slate-300 space-y-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white border-b border-yellow-500 pb-2">1. Uso del Servicio</h3>
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white border-b border-yellow-500 pb-2">2. Política de Citas y Cancelaciones</h3>
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white border-b border-yellow-500 pb-2">3. Cuentas de Usuario</h3>
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white border-b border-yellow-500 pb-2">4. Modificaciones</h3>
            ...
            <div class="mt-12 text-center">
                <a href="{{ url('/') }}" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-8 rounded-full transition-transform transform hover:scale-105">Regresar al Inicio</a>
            </div>
        </div>
    </div>
</div>
