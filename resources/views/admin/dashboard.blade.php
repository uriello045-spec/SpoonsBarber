...
<div class="min-h-screen bg-slate-50 dark:bg-zinc-900 text-slate-900 dark:text-gray-100 p-4 md:p-10 transition-colors duration-300 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10" data-aos="fade-up">
            <div class="bg-white dark:bg-zinc-800 p-8 rounded-3xl border border-slate-200 dark:border-zinc-700 hover:border-blue-500/50 dark:hover:border-[#3b82f6]/50 shadow-sm dark:shadow-xl transition-all group relative overflow-hidden">
            ...
            <div class="bg-white dark:bg-zinc-800 p-8 rounded-3xl border border-slate-200 dark:border-zinc-700 hover:border-cyan-500/50 dark:hover:border-[#06b6d4]/50 shadow-sm dark:shadow-xl transition-all group relative overflow-hidden">
            ...
            <div class="bg-white dark:bg-zinc-800 p-8 rounded-3xl border border-slate-200 dark:border-zinc-700 hover:border-emerald-500/50 dark:hover:border-[#10b981]/50 shadow-sm dark:shadow-xl transition-all group relative overflow-hidden">
        ...
        <div class="grid lg:grid-cols-2 gap-8" data-aos="fade-up" data-aos-delay="100">
            <div class="bg-white dark:bg-zinc-800 rounded-3xl border border-slate-200 dark:border-zinc-700 shadow-sm dark:shadow-xl overflow-hidden flex flex-col">
                <div class="p-6 border-b border-slate-100 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-900/80 flex justify-between items-center">
                ...
                <div class="p-6 flex-1 space-y-4">
                    @forelse($citas as $cita)
                        <div class="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-zinc-900 border border-slate-100 dark:border-zinc-700 hover:border-blue-400 dark:hover:border-[#3b82f6]/50 transition-all group">
                            <div class="w-12 h-12 rounded-xl bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-600 flex items-center justify-center text-blue-600 dark:text-[#3b82f6] font-black text-xl shadow-sm dark:shadow-inner">
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-3xl border border-slate-200 dark:border-zinc-700 shadow-sm dark:shadow-xl overflow-hidden flex flex-col">
                <div class="p-6 border-b border-slate-100 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-900/80">
                    <h3 class="text-xl font-black text-slate-800 dark:text-white flex items-center gap-2">
                        ⭐ Feedback Reciente
                    </h3>
                </div>
                ...
                <div class="p-6 flex-1 space-y-4">
                    @forelse($reseñas as $r)
                        <div class="p-5 rounded-2xl bg-slate-50 dark:bg-zinc-900 border border-slate-100 dark:border-zinc-700 hover:border-blue-400 dark:hover:border-[#3b82f6]/50 transition-all relative">
        ...
        @if(auth()->user()->is_superadmin)
            <div class="mt-8 bg-zinc-800 dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-700 dark:border-zinc-800 text-center shadow-xl relative overflow-hidden" data-aos="fade-up">
