...
@section('content')
<div class="min-h-screen py-12 bg-slate-50 dark:bg-[#0a0a0a] transition-colors duration-300 flex items-center justify-center p-4">
    
    <div class="w-full max-w-2xl p-8 bg-white dark:bg-[#111] rounded-3xl border border-slate-200 dark:border-[#222] shadow-sm dark:shadow-xl transition-all duration-300 relative overflow-hidden">
        ...
        <div class="text-center mb-8" data-aos="fade-down">
            <h1 class="text-3xl font-black text-slate-900 dark:text-[#d4af37] tracking-wide flex items-center justify-center gap-2">
        ...
        <form method="POST" action="{{ route('admin.barbers.store') }}">
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" maxlength="50"
                        ...
                        class="w-full p-3.5 rounded-xl bg-slate-50 dark:bg-[#0a0a0a] border border-slate-200 dark:border-[#333] text-slate-900 dark:text-white focus:bg-white dark:focus:bg-[#111] focus:ring-2 focus:ring-yellow-400/50 dark:focus:ring-[#d4af37]/50 focus:border-yellow-400 dark:focus:border-[#d4af37] outline-none transition font-medium
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="password" name="password" id="password_barber" required minlength="8" maxlength="20"
                            class="w-full p-3.5 rounded-xl bg-slate-50 dark:bg-[#0a0a0a] border border-slate-200 dark:border-[#333] text-slate-900 dark:text-white focus:bg-white dark:focus:bg-[#111] focus:ring-2 focus:ring-yellow-400/50 dark:focus:ring-[#d4af37]/50 focus:border-yellow-400 dark:focus:border-[#d4af37] outline-none transition
                            @error('password') border-red-500 @enderror">
                        
                        <div class="h-1.5 w-full bg-slate-200 dark:bg-zinc-800 rounded-full mt-2 overflow-hidden">
            ...
            <div class="flex flex-col-reverse md:flex-row items-center justify-end gap-4 mt-8 pt-6 border-t border-slate-100 dark:border-[#222]">
                <a href="{{ route('admin.barbers.index') }}" class="w-full md:w-auto text-center bg-slate-100 dark:bg-[#1a1a1a] border border-slate-200 dark:border-[#333] hover:bg-slate-200 dark:hover:bg-[#222] text-slate-700 dark:text-gray-300 font-bold px-6 py-3.5 rounded-xl transition-all">
                    Cancelar
                </a>
                <button type="submit" class="w-full md:w-auto bg-yellow-400 dark:bg-[#d4af37] hover:bg-yellow-500 dark:hover:bg-[#ffd700] text-slate-900 dark:text-black font-black px-8 py-3.5 rounded-xl shadow-sm dark:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                    Crear Barbero
                </button>
            </div>
        </form>
...
<script>
    ...
    passInputBarber.addEventListener('input', function() {
        ...
        if(strength >= 3) {
            ...
            feedbackTextBarber.className = "text-[11px] mt-1.5 font-bold text-yellow-600 dark:text-yellow-400";
        } else {
