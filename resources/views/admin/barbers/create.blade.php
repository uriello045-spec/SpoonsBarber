...
@section('content')
<div class="min-h-screen py-12 bg-slate-50 dark:bg-[#222222] transition-colors duration-300 flex items-center justify-center p-4">
    
    <div class="w-full max-w-2xl p-8 bg-white dark:bg-[#2a2a2a] rounded-3xl border border-slate-200 dark:border-zinc-700 shadow-sm dark:shadow-xl transition-all duration-300 relative overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.barbers.store') }}">
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" maxlength="50"
                        ...
                        class="w-full p-3.5 rounded-xl bg-slate-50 dark:bg-[#222222] border border-slate-200 dark:border-zinc-600 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-[#2a2a2a] focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-[#3b82f6]/50 focus:border-blue-500 dark:focus:border-[#3b82f6] outline-none transition font-medium
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="password" name="password" id="password_barber" required minlength="8" maxlength="20"
                            class="w-full p-3.5 rounded-xl bg-slate-50 dark:bg-[#222222] border border-slate-200 dark:border-zinc-600 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-[#2a2a2a] focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-[#3b82f6]/50 focus:border-blue-500 dark:focus:border-[#3b82f6] outline-none transition
                            @error('password') border-red-500 @enderror">
                        
                        <div class="h-1.5 w-full bg-slate-200 dark:bg-[#222222] rounded-full mt-2 overflow-hidden">
            ...
            <div class="flex flex-col-reverse md:flex-row items-center justify-end gap-4 mt-8 pt-6 border-t border-slate-100 dark:border-zinc-700">
                <a href="{{ route('admin.barbers.index') }}" class="w-full md:w-auto text-center bg-slate-100 dark:bg-[#2a2a2a] border border-slate-200 dark:border-zinc-600 hover:bg-slate-200 dark:hover:bg-[#333333] text-slate-700 dark:text-gray-300 font-bold px-6 py-3.5 rounded-xl transition-all">
                    Cancelar
                </a>
